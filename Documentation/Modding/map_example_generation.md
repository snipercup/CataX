...
| `Tools/examples/map_recipe_building_surfaces.json` | `Mods/Dimensionfall/Maps/generated_building_surfaces.json` | One validated building with a complete owned-room partition and complete authored overhead classification: its office is interior, garage is open space, and both roof/ceiling classifications exist at logical `z: 1`; it also retains authored exterior access and an opt-in composition requiring both surfaces, without generated overhead geometry. |
